...
export async function authorizeAndGetCookies(page: Page, url: string, username: string, password: string): Promise<Cookie[]> {
    ...
    await page.waitForURL('https://telegram.giapdc.ru:8443/index.php/home?db=gdc', { timeout: 10000 });

    // Проверка URL страницы
    await expect(page).toHaveURL('https://telegram.giapdc.ru:8443/index.php/home?db=gdc', { timeout: 10000 });
